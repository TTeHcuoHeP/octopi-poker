...
{title:'Find your next step.',copy:'Courses and guided study.'}
      ...
      <section id="faq" className="section tinted"><div className="section-heading"><p className="eyebrow">08 / A FEW THINGS YOU MAY BE WONDERING</p><h2>Before you <span>get started.</span></h2></div><div className="faq-list">{[['Do I need to understand solvers already?','My First Solver is designed to help less advanced players get comfortable with modern study tools. Guided Study adds regular sessions with a coach.'],['What can I use for free?','You get a 7-day free trial of the Professional plan — no credit card required. Explore the tools included in Professional, try them as part of your study routine and see how Octopi Poker fits your game before choosing a subscription.'],["Can beginners use OCTOPI POKER?","Absolutely. OCTOPI POKER helps new players understand the fundamentals of GTO poker, while giving experienced players the tools to study, practice, and refine more advanced strategies."],
["What is GTO in poker?","GTO, or Game Theory Optimal, is a way of playing that aims to keep your decisions balanced and difficult to exploit. Instead of relying on reads or specific opponent tendencies, it focuses on making strategically sound choices across a wide range of situations."],
["How does OCTOPI POKER help me improve?","OCTOPI POKER combines study, practice, and feedback in one learning flow. You can explore strategic concepts, test your decisions in realistic spots, review mistakes, and gradually build a stronger understanding of the game."],
["Do I need to use a solver to study with OCTOPI POKER?","Not necessarily. OCTOPI POKER is designed to make advanced poker strategy easier to learn without forcing you to work through complex solver outputs. You can start with guided tools and practical training, then go deeper into analysis as your skills develop."]].map(([q,a])=><details key={q}><summary>{q}<span aria-hidden="true">+</span></summary><p>{a}</p></details>)}</div></section>
